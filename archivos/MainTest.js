...
let objMtlModelUrl = {obj:'../assets/Gold_Star.obj', mtl:'../assets/Gold_Star.mtl', map:'../assets/Texture_gold.jpg'};

let objModelUrl = {obj:'../assets/spaceship.obj', map:'../assets/Texture_gold.jpg'};

let objModelUrlEarth = {obj:'../assets/earth.obj', map:'../assets/Texture_gold.jpg'};
...
async function loadObj(objModelUrl, objectList, position, scale)
{
    try
    {
...
async function loadObjMtl(objModelUrl, objectList, position, scale)
{
    try
    {
...
function createScene(canvas) 
{
    ...
    // Create the objects
    loadObj(objModelUrl, objectList, [-3,-4,-3], [1,1,1]);
    loadObj(objModelUrlEarth, objectList, [8,-3, 1], [5,5,5,5]);

    loadJson(jsonModelUrl.url, objectList);

    loadObjMtl(objMtlModelUrl, objectList, [1, 0, 0], [0.15, 0.15, 0.15]);
    loadObjMtl(R1, objectList, [1, 0, 0], [1, 1, 1]);
    loadObjMtl(R2, objectList, [1, 1, 0], [1, 1, 1]);
    loadObjMtl(R3, objectList, [1, 2, 0], [1, 1, 1]);
    loadObjMtl(R4, objectList, [1, -1, 0], [1, 1, 1]);
    loadObjMtl(R5, objectList, [1, 0.5, 0], [1, 1, 1]);
