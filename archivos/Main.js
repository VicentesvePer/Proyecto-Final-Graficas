...
let objModelSpaceship = {obj:'../assets/X-WING.obj', mtl:'../assets/X-WING.mtl'};
let objModelEarth = {obj:'../assets/earth.obj', mtl:'../assets/earth.mtl'};
let objModelLightning = {obj:'../assets/Lightning.obj', mtl:'../assets/blank.mtl'};
...
function createScene(canvas) 
{
    ...
    // Create the objects
    loadObjMtl(objModelSpaceship, objectList, [-8,4,0], [0.5,0.5,0.5], [0,0,0]);
    loadObjMtl(objModelEarth, objectList, [0,-2,20], [5,5,5], [0,0,0]);

    loadObjMtl(objModelLightning, objectList, [-3, 5, 0], [0.5,0.1,0.3], [-Math.PI/2,0,0]);
    loadObjMtl(objModelBull, objectList, [-3, 8, 0], [0.3,0.3,0.3], [-Math.PI/2,0,0]);
    loadObjMtl(objMtlModelUrl, objectList, [1, 5, 0], [0.05, 0.05, 0.05], [0,0,Math.PI/2]);
